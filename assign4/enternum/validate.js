function checkForm(form)
{
  ...
  $.post(
      'form.php',
      {"first_name":form.fname.value, "last_name":form.lname.value, "age":form.age.value, "email":form.email.value, "year":form.year.value,"gender":form.gender.value, "password":form.password.value},
      function(resData){
